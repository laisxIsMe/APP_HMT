...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimension(R.styleable.CircularProgress_border_Width,
                DEFAULT_BORDER_WIDTH * density);
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.CircularProgress_red);
        mColors[1] = context.getResources().getColor(R.color.CircularProgress_yellow);
        mColors[2] = context.getResources().getColor(R.color.CircularProgress_green);
        mColors[3] = context.getResources().getColor(R.color.CircularProgress_blue);
